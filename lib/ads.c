...
/*
 * digitalWrite:
 *  It may sem odd to have a digitial write here, but it's the best way
 *  to pass paramaters into the chip in the wiringPi way of things.
 *  We have 2 digital registes:
